...
<style>
  /* 1. Astro Theme Cleanup: Ensure the app has full focus */
  ...
  /* 2. Prevent the TOC component from injecting '#' icons or sidebars */
...
<div id="snowman-toolbar">
  ...
  <div id="snowman-toolbar-right" class="flex items-center gap-4">
...
<script type="module" is:inline>
  ...
  canvas.addEventListener("mousedown", (e) => {
    drawing = true;
    allStrokes.push({ pts: [getPos(e)], color: currentColor, size: currentSize, mode: currentMode });
  });
