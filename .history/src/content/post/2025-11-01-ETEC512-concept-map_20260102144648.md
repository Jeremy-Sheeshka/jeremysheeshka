...
const graphData = {
    ...
    links: [
        ...
        // THE CROSS-THEORY CONNECTIONS (THE "MESSY" LINKS)
        { source: "reinforcement", target: "dopamine" }, // Behaviorism <-> Neuroscience
        { source: "schema", target: "neuroplasticity" }, // Cognitivism <-> Neuroscience
        { source: "zpd", target: "working-memory" }, // Constructivism <-> Cognitivism
        { source: "modeling", target: "pavlov" }, // Social <-> Behaviorism
        { source: "community-of-practice", target: "distributed-knowledge" }, // Social <-> Connectivism
        { source: "ai-in-education", target: "distributed-knowledge" } // Tech <-> Connectivism
    ]
};
