...
<style>
  /* 1. HIDE ARTIFACTS: Toggle Switcher, Tags, Dates, and Nav */
  header, nav, footer, .site-header, .site-footer, .main-nav,
  .post-tags, .post-meta, .taxonomy, .tag-list, 
  time, .read-time, .theme-toggle, #theme-toggle, [id*="theme-toggle"],
  ...
  /* 3. RESPONSIVE TOOLBAR & BUTTONS */
  #squiggle-toolbar {
    background: var(--theme-bg-card, #ffffff);
    border: 1px solid #ccc;
    border-radius: 0.75rem;
    padding: 0.5rem; /* Shrunk padding */
    display: flex;
    align-items: center;
    justify-content: center; /* Center for better flow on mid-screens */
  ...
  /* Shrink the Slider for medium screens */
  #brushSize {
    width: 80px !important; /* Fixed width to prevent overflow */
  }

  .color-option {
    width: 1.5rem; /* Shrunk color circles */
    height: 1.5rem;
    border-radius: 50%;
    cursor: pointer;
...
<div id="squiggle-toolbar">
  ...
  <div class="flex items-center gap-1">
    <label class="text-[10px] uppercase font-bold">Size</label>
