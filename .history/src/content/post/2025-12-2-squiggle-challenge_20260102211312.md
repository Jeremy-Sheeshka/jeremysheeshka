...
<style>
  /* 1. NUCLEAR METADATA & TAG WIPEOUT */
  /* This targets the SVG icons, the list items, and the text for tags/date/read-time */
  ...
  svg[class*="tag"], .icon-tag, [data-icon*="tag"],
  li[class*="tag"], ul[class*="tag"], a[href*="/tags/"] {
...
<script type="module" is:inline>
  // ... (Firebase and Canvas logic remains unedited as per previous version)
