...
<style>
/* THE FIX: Prevent hashtag icons and TOC sidebars */
...
.fake-h2 { font-size: 1.5rem; font-weight: 600; color: #1f2937 !important; margin-bottom: 0.5rem; display: block; }

/* LEGEND FIX: Forced text color for visibility on all themes */
.legend { padding: 1rem; border-top: 1px solid #e5e7eb; display: flex; flex-wrap: wrap; gap: 1rem; justify-content: center; background: #fafafa; }
.legend-item { display: flex; align-items: center; gap: 0.5rem; font-size: 0.85rem; color: #374151 !important; }
.legend-color { width: 14px; height: 14px; border-radius: 50%; border: 1px solid #ddd; flex-shrink: 0; }
.legend-label { color: #374151 !important; font-weight: 600; }
...
<p style="color: #6b7280; font-size: 0.85rem; margin-top: 0.5rem; text-align: center;">• Scroll to zoom • Click and drag nodes to move</p>
</div>
