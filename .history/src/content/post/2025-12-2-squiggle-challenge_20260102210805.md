...
<style>
  ...
  /* 3. BRUSH SIZE & THEME TEXT LOCK */
  /* This ensures 'SIZE' and the number flip correctly */
  #draw-a-squiggle-app, 
  ...
  .control-btn {
    ...
    cursor: pointer;
    background: #e5e7eb;
    color: #374151 !important; /* Keep button labels dark for UI contrast */
    border: none;
    white-space: nowrap;
  }
  ...
  #brushSize { width: 80px !important; }
