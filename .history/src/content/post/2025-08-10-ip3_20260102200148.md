...
/* 3. THE MAIN FIX: Force body text to follow theme switcher */
.content-body {
    line-height: 1.6;
    color: var(--theme-text) !important;
}

/* Force all standard elements inside the body to follow the theme color */
.content-body p, 
.content-body ul, 
.content-body li, 
.content-body strong,
...
blockquote {
    ...
    padding-left: 1em;
    margin: 1.5rem 0;
    /* Use theme text but slightly softer for quotes */
    color: var(--theme-text) !important;
    opacity: 0.85;
    font-style: italic;
}
...
/* Custom Reference Box - Replacing :::note for better theme support */
.reference-box {
