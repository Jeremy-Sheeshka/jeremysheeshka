...
<style>
  /* 1. AGGRESSIVE METADATA & TAG WIPEOUT */
  /* This targets the tag list, the specific # tag, date, and read-time artifacts */
  ...
  /* 3. THEME COLOR LOCK - Ensures 'Size' and Number flip between themes */
  .squiggle-title,
  .gallery-header,
  .brush-label,
  #sizeValue,
  ...
  .control-btn {
    ...
    cursor: pointer;
    background: #e5e7eb;
    color: #374151 !important; /* Kept dark for contrast on grey buttons */
    border: none;
    white-space: nowrap;
  }
