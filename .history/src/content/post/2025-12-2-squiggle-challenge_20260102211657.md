...
<style>
  ...
  /* This targets the tag text, the icon, AND the reading time text specifically */
  ...
  .control-btn {
    ...
    cursor: pointer;
    background: #e5e7eb;
    color: #374151 !important; /* Fixed dark for contrast */
    border: none;
    white-space: nowrap;
  }
  ...
  .squiggle-title {
    ...
    font-size: 1.75rem;
    font-weight: bold;
    margin-top: 4rem; /* Higher margin now that top meta is gone */
...
<script type="module" is:inline>
  // Firebase and Canvas logic remain unchanged
