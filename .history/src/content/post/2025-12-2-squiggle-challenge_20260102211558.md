...
<style>
  ...
  /* This hides the tag icon, tag text, reading time, date, and theme switcher */
  ...
  /* Targeted Flex containers often used for the meta-row */
  .flex.items-center.gap-x-2, .flex.items-center.gap-x-1, .mb-4.flex.flex-wrap.gap-2,
  .mb-6.flex.flex-wrap.gap-3, .flex.items-center.text-sm {
  ...
  .squiggle-title {
    ...
    font-size: 1.75rem;
    font-weight: bold;
    margin-top: 4rem; /* Higher margin to account for hidden top bar */
