...
<style>
  /* 1. THE "NUCLEAR" HIDE - Targeting the specific metadata row */
  /* This targets the container that holds the tag icon, tag text, and read time */
  ...
  .flex.items-center.gap-x-2, .flex.items-center.gap-x-1, .mb-4.flex.flex-wrap.gap-2 {
  ...
  .control-btn {
    ...
    cursor: pointer;
    background: #e5e7eb;
    color: #374151 !important; /* Keep text dark for button contrast */
    border: none;
    white-space: nowrap;
  }
  ...
  .squiggle-title {
    ...
    font-size: 1.75rem;
    font-weight: bold;
    margin-top: 3rem; /* Push down since top nav is hidden */
...
<script type="module" is:inline>
  // Firebase configuration and logic remains unedited to ensure app functionality
