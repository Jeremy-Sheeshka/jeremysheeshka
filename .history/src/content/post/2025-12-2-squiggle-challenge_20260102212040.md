...
<style>
  ...
  /* Targets every possible container for tags, dates, and reading time */
  ...
  /* This targets the specific row usually containing the / 5 min read icon */
  .flex.items-center, .gap-x-2, .gap-x-1, .text-sm, .opacity-70, .opacity-80,
  /* Target the theme's default title and meta area directly */
  h1, .prose > div:first-child, article > div:first-child, .mb-8, .mb-4 {
  ...
  /* 2. THEME COLOR LOCK - Fixes 'Size' and Number visibility */
  .squiggle-title,
  .gallery-header,
  .brush-label,
  #sizeValue,
  ...
  .squiggle-title {
    display: block !important; /* Force this title to show */
