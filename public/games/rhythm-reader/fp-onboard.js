...
(function(){
  ...
  function hideChrome(on){["#drill-frame",".metronome--top",".dock"].forEach(function(sel){var e=$(sel);if(e){e.style.display=on?"none":"";}});}
