...
<div class="reflection-dropdown-menu">
  <div class="dropdown-item">
    <dt class="dropdown-question">Learning Scenario Description</dt>
...
<div class="reflection-dropdown-menu">
  <div class="dropdown-item">
    <dt class="dropdown-question">Learning Scenario Analysis</dt>
    <dd class="dropdown-answer">
      <p>
      <!-- ANALYSIS START -->
...
<p>
Needless to say, that while just being a minimalistic drawing on the outside, the activity itself that this drawing creates alongside my introduction and depiction of "following the rules," becomes a playful exercise that reveals a deeper cycle of modeling, confidence-building, and social reinforcement that aligns closely with Bandura’s conception socially situated learning.
</p><br>
...
<br>
Bandura, A. (2011). Social cognitive theory. In P. A. M. Van Lange, A. W. Kruglanski, & E. T. Higgins (Eds.), Handbook of theories of social psychology (Vol. 1, pp. 349–373). SAGE Publications.
<br>
...
Schrader, D. E. (2015). Constructivism and learning in the age of social media. New Directions for Teaching and Learning, 2015(144), 15–28.
<br>
{#% endasideReadmore {#%#}
<br>
    </dd>
...
<style>
  ...
  /* ⭐ Responsive grid for small duck cards ⭐ */
  #duckGallery {
    display: grid;
    gap: 0.75rem;
...
<!-- TOOLBAR -->
<div id="duck-toolbar">
  <div id="duck-toolbar-left">Brush:</div>
  <div id="duck-toolbar-right">
...
<div id="duck-canvas-wrapper">
  <div id="duck-canvas-inner">
    <img
      ...
      data-no-optimization="true"
      src="/assets/images/blog/drawaduckHIRES.png"
      alt="Duck drawing template"
    />
...
<script type="module">
  ...
  function start(evt) {
    ...
    ctx.globalCompositeOperation =
      currentMode === "erase" ? "destination-out" : "source-over";
  }
  ...
  submitDuckBtn.addEventListener("click", async () => {
    ...
    alert("Birds of a feather quack together!");
  ...
  async function getModeratorPassword() {
    ...
    const configRef = doc(db, "moderatorConfig", "duckModeration");
  ...
  function renderGallery(docs) {
    ...
    docs.forEach((duckDoc) => {
      ...
      card.innerHTML = `<img src="${data.img}" alt="Submitted duck art">`;
