...
<div class="flex flex-col items-center gap-6">
  <div class="w-full max-w-[700px]">
    {#% image "./src/assets/images/blog/Dawn1.png", "Facebook post" {#%#}
  </div>

  <div class="w-full max-w-[700px]">
    {#% image "./src/assets/images/blog/Dawn2.png", "Facebook post" {#%#}
  </div>

  <div class="w-full max-w-[700px]">
    {#% image "./src/assets/images/blog/Dawn3.png", "Facebook post" {#%#}
  </div>
</div> <br>
...
{#% image "./src/assets/images/blog/lestercentre.jpg", "Lester Centre" {#%#}
