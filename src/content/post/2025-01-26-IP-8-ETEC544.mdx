...
<div className="story-section">
  ...
  <div className="story-cards">
    <div className="story-card">
      ...
      <p className="story-card-text">Earthbound takes place in a quirky sci-fi world where a young boy with gains psychic powers encounters both supernatural mysteries and humorous situations.</p>
    </div>
